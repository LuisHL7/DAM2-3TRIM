...
"border:none")
        ...
        self.BtnClose.setGeometry(QtCore.QRect(690, 420, 90, 40))
        font = QtGui.QFont()
...
"}")
        ...
        self.BtnDelete.setGeometry(QtCore.QRect(490, 420, 90, 40))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.BtnClean.setGeometry(QtCore.QRect(590, 420, 90, 40))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.BtnUpdate.setGeometry(QtCore.QRect(390, 420, 90, 40))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.BtnSave.setGeometry(QtCore.QRect(290, 420, 90, 40))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
...
"border:none")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../Project/images/dateta.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon6)
        self.pushButton.setIconSize(QtCore.QSize(50, 50))
        self.pushButton.setObjectName("pushButton")
        self.LbWelcome = QtWidgets.QLabel(self.tab_2)
        self.LbWelcome.setGeometry(QtCore.QRect(20, 480, 71, 16))
...
"border:none")
        ...
        self.cliTable_2 = QtWidgets.QTableWidget(self.tab)
        self.cliTable_2.setGeometry(QtCore.QRect(30, 90, 981, 301))
        self.cliTable_2.setAutoFillBackground(False)
        self.cliTable_2.setStyleSheet("background-color: rgba(0, 0, 0,0%);\n"
"border:none")
        self.cliTable_2.setDragEnabled(False)
        self.cliTable_2.setAlternatingRowColors(False)
        self.cliTable_2.setGridStyle(QtCore.Qt.SolidLine)
        self.cliTable_2.setObjectName("cliTable_2")
        self.cliTable_2.setColumnCount(7)
        self.cliTable_2.setRowCount(0)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.cliTable_2.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.cliTable_2.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.cliTable_2.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.cliTable_2.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.cliTable_2.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.cliTable_2.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.cliTable_2.setHorizontalHeaderItem(6, item)
        self.cliTable_2.horizontalHeader().setCascadingSectionResizes(False)
        self.cliTable_2.horizontalHeader().setHighlightSections(True)
        self.cliTable_2.horizontalHeader().setMinimumSectionSize(50)
        self.cliTable_2.verticalHeader().setDefaultSectionSize(50)
        self.cliTable_2.verticalHeader().setMinimumSectionSize(50)
        self.cliTable_2.verticalHeader().setSortIndicatorShown(False)
        self.cliTable_2.verticalHeader().setStretchLastSection(True)
        self.TxtUser = QtWidgets.QLineEdit(self.tab)
        self.TxtUser.setGeometry(QtCore.QRect(30, 30, 221, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
...
"border:none")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../Project/images/folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen.setIcon(icon8)
        self.actionOpen.setObjectName("actionOpen")
        self.actionExport = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../Project/images/exportar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionExport.setIcon(icon9)
        self.actionExport.setObjectName("actionExport")
        self.actionImport = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("../Project/images/importar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImport.setIcon(icon10)
        self.actionImport.setObjectName("actionImport")
        self.actionCloseTB = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("../Project/images/close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.TxtName.setPlaceholderText(_translate("MainWindow", "Ingrese el nombre"))
        self.label_3.setText(_translate("MainWindow", "Categoría:"))
        ...
        self.TxtPriceC.setPlaceholderText(_translate("MainWindow", "Ingrese el precio de costo"))
        self.label_4.setText(_translate("MainWindow", "Precio:"))
        self.TxtPriceV.setPlaceholderText(_translate("MainWindow", "Ingrese el precio de venta"))
        self.label_5.setText(_translate("MainWindow", "Precio:"))
        self.label_6.setText(_translate("MainWindow", "Estado:"))
        self.TxtStock.setPlaceholderText(_translate("MainWindow", "Ingrese la cantidad"))
        self.label_7.setText(_translate("MainWindow", "Cantidad:"))
        self.label_9.setText(_translate("MainWindow", "Proveedor:"))
        self.label_10.setText(_translate("MainWindow", "Fecha Ingreso:"))
        self.radioButton.setText(_translate("MainWindow", "Disponible"))
        self.RbGroupStatus.setText(_translate("MainWindow", "No Disponible"))
        self.TxtId.setPlaceholderText(_translate("MainWindow", "Ingrese el código"))
        self.TxtName_2.setPlaceholderText(_translate("MainWindow", "Seleccione la fecha -->"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Registro de Productos"))
        item = self.cliTable_2.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Código"))
        item = self.cliTable_2.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Nombre"))
        item = self.cliTable_2.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Categoría"))
        item = self.cliTable_2.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Cantidad"))
        item = self.cliTable_2.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Precio Costo"))
        item = self.cliTable_2.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Precio Venta"))
        item = self.cliTable_2.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "Proveedor"))
        self.TxtUser.setPlaceholderText(_translate("MainWindow", "Ingrese el código"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Consulta de Productos"))
