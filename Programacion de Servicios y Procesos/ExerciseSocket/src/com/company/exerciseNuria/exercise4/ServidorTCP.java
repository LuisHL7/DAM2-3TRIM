package com.company.exerciseNuria.exercise4;
...
public class ServidorTCP {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            idcliente++;
            System.out.println(arrayObjetosProfesor[0]);
            System.out.println(arrayObjetosProfesor[1]);
            System.out.println(arrayObjetosProfesor[2]);
            System.out.println(arrayObjetosProfesor[3]);
            System.out.println(arrayObjetosProfesor[4]);
