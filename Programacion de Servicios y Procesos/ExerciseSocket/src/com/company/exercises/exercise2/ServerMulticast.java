package com.company.exercises.exercise2;
...
public class ServerMulticast extends JFrame {
    ...
    public static void main(String[] args) {
        try {
            ...
            grupo = InetAddress.getByName("225.0.01");
        } catch (IOException e) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ServerMulticast frame = new ServerMulticast();
